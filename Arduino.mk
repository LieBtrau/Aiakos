...
ARDUINO_CORE_PATH = $(ARDUINO_DIR)/hardware/arduino/cores/$(shell $(PARSE_BOARD) $(BOARD_TAG) build.core)
endif
...
LOCAL_PDE_SRCS  = $(wildcard **/*.pde) $(wildcard *.pde)
LOCAL_INO_SRCS  = $(wildcard **/*.ino) $(wildcard *.ino)
...
STATIC_LIBS = $(patsubst %,$(OBJDIR)/%,$(LOCAL_STATIC_LIBS))
...
AVRDUDE_ARD_OPTS = -c $(AVRDUDE_ARD_PROGRAMMER) -b $(AVRDUDE_ARD_BAUDRATE) -P $(ARDUINO_PORT) $(AVRDUDE_ARD_EXTRAOPTS)
...
$(TARGET_ELF): 	$(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS)
		$(CC) $(LDFLAGS) -o $@ $(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS) $(STATIC_LIBS) -lc -lm
...
clean:
		$(REMOVE) $(LOCAL_OBJS) $(CORE_OBJS) $(LIB_OBJS) $(CORE_LIB) $(STATIC_LIBS) $(TARGETS) $(DEP_FILE) $(DEPS)
...
monitor:
		screen $(ARDUINO_PORT) $(SERIAL_MONITOR_BAUDRATE)
