...
btCharacteristic rfid_key("f1a87912-5950-479c-a5e5-b6cc81cd0502",        //private service
                          ...
                          btCharacteristic::WRITE,5,                     //properties+length
...
bool KeyFob::initBlePeripheral()
{
    ...
    rfid_key.setHandle(cfg->getRfidHandle());
    ias_alertLevel.setHandle(cfg->getIasHandle());

    byte value[4];
    byte length;
    if(!_ble->readLocalCharacteristic(&rfid_key, value, length))
    {
        ...
        word handle=_ble->getLocalHandle(&rfid_key);
